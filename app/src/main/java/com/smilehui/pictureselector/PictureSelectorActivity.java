...
import com.smilehui.pictureselector.utils.ParcelUtils;
import com.smilehui.pictureselector.utils.PermissionCheckUtil;
...
public class PictureSelectorActivity extends Activity {
    ...
    private void initView() {
        ...
        this.mPicType.setTextColor(ContextCompat.getColor(this, R.color.rc_picsel_toolbar_send_text_normal));
        ...
        this.perWidth = (getResources().getDisplayMetrics().widthPixels - Utils.dip2px(4.0F)) / 3;
    }
    ...
    private void updateToolbar() {
        ...
        if (sum == 0) {
            ...
            this.mBtnSend.setTextColor(ContextCompat.getColor(this, R.color.rc_picsel_toolbar_send_text_normal));
            this.mBtnSend.setText(String.format(this.getResources().getString(R.string.rc_picsel_toolbar_send_num)
                    , new Object[]{Integer.valueOf(sum)}));
            this.mPreviewBtn.setEnabled(true);
            this.mPreviewBtn.setText(String.format(this.getResources().getString(R.string.rc_picsel_toolbar_preview_num)
                    , new Object[]{Integer.valueOf(sum)}));
        }
    }
    ...
    public static class PreviewBtn extends LinearLayout {
        ...
        public void setEnabled(boolean enabled) {
            ...
            this.mText.setTextColor(ContextCompat.getColor(getContext(), color));
        }
    ...
    public static class PicItem implements Parcelable {
        ...
        public static final Creator<PictureSelectorActivity.PicItem> CREATOR = new Creator<PictureSelectorActivity.PicItem>() {
    ...
    private class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (position == 0) {
                ...
                AlbumBitmapCacheHelper.getInstance().addPathToShowList(path);
                holder.image.setTag(path);
                Bitmap bitmap = AlbumBitmapCacheHelper.getInstance().getBitmap(path, PictureSelectorActivity.this.perWidth, PictureSelectorActivity.this.perWidth,
